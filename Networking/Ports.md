...
| **443** | **HTTPS** | **HTTPS (Hypertext Transfer Protocol Secure)** is HTTP over **TLS** encryption. It protects data from interception and ensures confidentiality, integrity, and authentication. |
